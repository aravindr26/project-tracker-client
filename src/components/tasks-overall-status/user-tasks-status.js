...
var UserTasksStatus = (function () {
    function UserTasksStatus() {
        this.options = {
            chart: {
                type: 'area'
            },
            title: {
                text: 'Bug/Feature Status'
            },
            xAxis: {
                allowDecimals: false,
                labels: {
    ...
    UserTasksStatus.prototype.ngOnInit = function () {
    };
    UserTasksStatus = __decorate([
        core_1.Component({
...
exports.UserTasksStatus = UserTasksStatus;
//# sourceMappingURL=user-tasks-status.js.map