...
var AuthenticationService = (function () {
    function AuthenticationService(http) {
        this.http = http;
        this.authenticationBaseURL = 'http://localhost:3002/user/';
        this.headers = new http_1.Headers({ 'Content-Type': 'application/json' });
        this.options = new http_1.RequestOptions({ headers: this.headers });
    }
    AuthenticationService.prototype.addUserData = function (userData) {
        return this.http.post(this.authenticationBaseURL + 'userSignUp', userData, this.options)
            .map(this.extractData)
            .catch(this.handleError);
    };
    AuthenticationService.prototype.checkUserLogin = function (userData) {
